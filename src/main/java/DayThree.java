...
public class DayThree {
    ...
    public static int partOne(String input) {
        ...
        List<String> visitedHouses = new ArrayList<String>();
        ...
        for(int i = 0; i < instructions.length; i++) {
            ...
            if(instructions[i] == '^')
                if(i % 2 == 0)
                    ...
                    robotX--;
            if(i % 2 == 0) {
                if(!visitedHouses.contains(santaX + "-" + santaY))
                    visitedHouses.add(santaX + "-" + santaY);
            } else {
                if(!visitedHouses.contains(robotX + "-" + robotY))
                    visitedHouses.add(robotX + "-" + robotY);
            }
        }
        return visitedHouses.size();
    }
    ...
    public static void main(String... args) {
        System.out.printf("Part One: %d", DayThree.partOne(input));
        System.out.printf("%nPart two: %d", DayThree.partTwo(input));
    }
