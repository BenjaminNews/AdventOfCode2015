public class DayFive {
    ...
    public static int partOne(String input) {
        ...
        for(String inputLine : input.split("\n"))
            if (containsEnoughVowels(inputLine))
                if (containsMatchingNeighbour(inputLine))
                    if (containsNoDisallowedCharacters(inputLine))
                        validCount++;
        return validCount;
    }

    private static boolean containsNoDisallowedCharacters(String input) {
        return !input.contains("ab") && !input.contains("cd") && !input.contains("pq") && !input.contains("xy");
    }

    private static boolean containsEnoughVowels(String input) {
        int vowelCount = 0;
    ...
    private static boolean containsMatchingNeighbour(String input) {
    ...
    private static boolean containsPair(String input) {
        char[] allCharacters = input.toCharArray();
        for(int i = 0; i + 1 < allCharacters.length; i++) {
    ...
    public static void main(String... args) {
        System.out.printf("Part one: %d", DayFive.partOne(input));
        System.out.printf("%nPart two: %d", DayFive.partTwo(input));
    }

    private static final String input = "rthkunfaakmwmush\n" +
                                        "qxlnvjguikqcyfzt\n" +
                                        "sleaoasjspnjctqt\n" +
                                        "lactpmehuhmzwfjl\n" +
                                        "bvggvrdgjcspkkyj\n" +
